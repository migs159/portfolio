...
// Accept either `project` or `p` as input
...
// Build tags from both explicit tags and type field (which may be array, JSON, or CSV)
$tags  = [];
if (isset($project['tags']) && is_array($project['tags'])) {
    $tags = $project['tags'];
}
// Decode type field into readable labels and merge
$types = [];
